...
<body>
    ...
    <section class="escola">
        <div class="escola-div-conteudo">
            ...
            <p class="escola-texto-um">a escola Romario Matins foi fundada em 29 de abrio de 1929, com o intuito de trazer aprendizado para as crianças das pequenas cidades ao redor</p>
            <p class="escola-texto-dois">A turma mais estudiosa e famosa é a Segunda Série A. Nós somos super unidos e a turma favorita por todos os professores e professoras que nos ajudam!</p>
        </div>
        <img class="escola-imagem" src="https://www.gis.seed.pr.gov.br/gis/exibirFoto.jpg?codFoto=8588">
    </section>
    <section class="estudante">
        ...
        <div class="estudante-div">
            <img class="estudante-imagem" src="Marcelo.jpeg" alt="foto do Matheus">
